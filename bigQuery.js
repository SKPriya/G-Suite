...
var QUERY_NAME = " Most common words in all of Shakespheare's works";
var PROJECT_ID = 'qwiklabs-gcp-f4df24037d9a9c63';
...
function runQuery() {
   var request = {
     query:
         'SELECT'+ 'LOWER(word) AS word, '+'FROM [bigquery-public-data:samples.shakespeare]' + 'GROUP BY word' +'ORDER BY count' + 'DESC LIMIT 10'
};
...
var rows = querResults.rows;
while(queryResults.pagetoken){
    queryResults = BigQuery.Jobs.getQueryResults(PROJECT_ID,jobID,{ pageToken: queryResults.pageToken
    });
